...
export const ROCK_PLACEMENTS: RockPlacement[] = [
  { x: 7.2, z: -5.0, scale: 1.15, rotation: 0.4 },
  { x: 9.5, z: -3.7, scale: 0.78, rotation: 1.3 },
  { x: 12.1, z: -4.2, scale: 1.05, rotation: 2.2 },
  { x: 14.5, z: -5.8, scale: 0.7, rotation: 0.8 },
  { x: 12.8, z: -7.4, scale: 0.9, rotation: 1.9 },
  { x: 9.6, z: -7.3, scale: 0.65, rotation: 2.7 },
  { x: 15.0, z: -3.7, scale: 0.58, rotation: 1.1 },
  ...
  { x: 17, z: -11.8, scale: 0.85, rotation: 2.4 },
